...
window.I18N_DATA.zh = {
  ...
  "shutter_undecodable": "⚪ 已识别厂商，但该品牌的快门次数因机型而异，本工具尚无法解析。",
  ...
  "shutter_coverageNote": "目前 Fujifilm、Sony、Leica 相机只要存有快门次数即可直接显示。Canon、Panasonic 的照片可以读取相机信息，但各厂商的存储方式不同，本工具尚无法解析其快门次数。智能手机（iPhone、大多数安卓手机等）本身就没有快门次数这一概念，因此无法确认。",
