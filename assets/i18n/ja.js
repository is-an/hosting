...
window.I18N_DATA.ja = {
  ...
  "meta_description": "計算機・変換ツール・ジェネレーター・ゲームなど15種類の無料オンラインツールを一箇所で。",
  ...
  "shutter_undecodable": "⚪ メーカーは確認できましたが、このブランドのシャッター回数は機種ごとに保存方式が異なり、このツールではまだ解析できません。",
  ...
  "shutter_coverageNote": "現在、Fujifilm・Sony・Leicaのカメラはシャッター回数が保存されていればすぐに確認できます。Canon・Panasonicはカメラ情報は読み取れますが、メーカーごとに保存形式が異なるためシャッター回数の解析はまだ対応していません。スマートフォン（iPhone、ほとんどのAndroid端末など）にはそもそもシャッター回数という概念がないため確認できません。",
