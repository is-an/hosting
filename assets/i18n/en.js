...
window.I18N_DATA.en = {
  ...
  "footer_gamesLink": "Games",
  "footer_sajuLink": "Saju & Fortune",
  "footer_home": "Home",
  "footer_contact": "Send feedback",
  "footer_guide": "Guide",
  "footer_faq": "FAQ",
  "footer_privacy": "Privacy Policy",
  "privacy_meta_title": "Privacy Policy | is-an",
  "privacy_meta_description": "Privacy policy for is-an.github.io: what information is collected, browser storage use, and Google AdSense advertising cookies.",
  "privacy_eyebrow": "Information",
  "privacy_title": "Privacy Policy",
  "privacy_updated": "Last updated: September 1, 2026",
  "privacy_intro_title": "Overview",
  "privacy_intro_body": "is-an.github.io (“the Site”) is a collection of free online tools with no sign-up or login. Most features, such as calculators and converters, run entirely in your browser, and the values you enter are not sent to any server.",
  "privacy_collect_title": "Information We Collect",
  "privacy_collect_body": "The Site does not directly collect or store personally identifiable information such as your name, email address, or phone number. Numbers or text you type into the tools are processed only within your browser and are not stored or transmitted. If you email us through the feedback link, the content you write and your sending email address are used only to handle your inquiry.",
  "privacy_storage_title": "Browser Storage (localStorage)",
  "privacy_storage_body": "The Site stores your display theme (light/dark), language, and the best scores of some mini games in your browser’s localStorage. These values are not sent to a server and are not shared with other users. You can clear them at any time using your browser’s clear-site-data feature.",
  "privacy_ads_title": "Advertising and Cookies",
  "privacy_ads_body": "The Site shows ads through Google AdSense. Google and third-party advertising vendors may use cookies to serve personalized ads based on your visits to this and other sites. The advertising cookies themselves are managed by those vendors, not by the Site.",
  "privacy_ads_optout": "You can turn off personalized advertising here:",
  "privacy_ads_link_google": "Google Ads Settings",
  "privacy_ads_link_aboutads": "aboutads.info ad choices",
  "privacy_hosting_title": "Hosting and Access Logs",
  "privacy_hosting_body": "The Site is hosted on GitHub Pages (GitHub, Inc.). While serving pages, standard web server access logs such as IP address and browser type may be processed by the hosting provider.",
  "privacy_children_title": "Children’s Privacy",
  "privacy_children_body": "The Site is not directed to children under 14 and does not knowingly collect personal information from children.",
  "privacy_changes_title": "Changes to This Policy",
  "privacy_changes_body": "This policy may be updated to reflect changes in law or in the service, and any changes will be posted on this page.",
  "privacy_contact_title": "Contact",
  "privacy_contact_body": "For questions about how your information is handled, please email us at:",
  "privacy_contact_email": "isablog@naver.com",
  "privacy_related": "Related links",
  ...
  "nav_guide": "Guide",
  "guide_meta_title": "Salary, Loan & Age Calculation Guides | is-an",
  "guide_meta_description": "Guides to commonly confused money and everyday calculations — net salary, loan repayment methods, Korean age, savings interest, and dollar-cost averaging — explained with examples.",
  "guide_eyebrow": "Calculation guides",
  "guide_title": "Guide",
  "guide_copy": "Everyday money and life calculations, explained with worked examples alongside the calculators.",
  "guide_read": "Read",
  "guide_related": "Related posts",
  "guide_back": "Back to posts",
  ...
  "home_searchLabel": "Search tools",
  "home_searchButton": "Search",
  "home_index_title": "All tools",
  "home_search_results": "Search results",
  "home_view_all": "View all →",
  "home_recent_title": "Recently used",
  "home_recent_clear": "Clear history",
  "home_favorites_title": "Favorites",
  "home_empty_title": "No results found",
  "home_empty_copy": "Try a different keyword or browse all tools.",
  "home_empty_action": "Browse all tools",
  "home_guides_title": "Guides",
  "header_tagline": "Tools",
  "header_menuLabel": "Open menu",
  "footer_privacy_note": "Every calculation runs in your browser; your input is never sent to a server.",
  "home_eyebrow": "Free online tools",
  "home_title": "Your everyday calculations, in one place",
  "home_copy": "Calculators, converters, games, lotto and Saju — the tools people reach for most, all free.",
  "home_trust": "No sign-up · Runs in your browser · Completely free",
  "home_searchPlaceholder": "Search tools... (e.g. BMI, salary, lotto)",
  "home_about_title": "About is-an tools",
  "home_about_copy": "is-an is a collection of free online tools you can use right away without signing up. From salary, loan and age calculators to unit converters, mini games and a lotto number generator, it gathers the features people look for most. Every calculation runs in your browser, so your input is never sent to a server.",
  ...
  "faq_meta_title": "Frequently Asked Questions | is-an",
  "faq_meta_description": "Common questions about using is-an.github.io tools, plus service-specific FAQs, all in one place.",
  "faq_eyebrow": "Help",
  "faq_page_title": "Frequently Asked Questions",
  "faq_page_copy": "Common questions about using the site, along with questions specific to each tool.",
  "faq_cat_general": "General questions",
  "lotto_faq_title": "❓ Frequently asked questions",
  "lotto_faq1_q": "How is this different from a store's Auto pick?",
  "lotto_faq1_a": "There is no difference. A store's Auto pick is also a random draw, and this tool picks 6 distinct numbers at random in the same way.",
  "lotto_faq2_q": "Can the same combination come up if I generate several times?",
  "lotto_faq2_a": "Numbers never repeat within a single combination. If you generate multiple combinations they can overlap with each other, but the chance is very low.",
  "lotto_faq3_q": "Does fixing numbers raise my odds of winning?",
  "lotto_faq3_a": "No. Whichever numbers you choose, the first-prize odds for one 6-number combination are the same: 1 in 8,145,060.",
  "lotto_faq4_q": "Are the generated numbers stored on a server?",
  "lotto_faq4_a": "No. Number generation happens entirely in your browser and is never sent to or stored on a server.",
  ...
  "shutter_undecodable": "⚪ Manufacturer identified, but this tool can't decode this brand's shutter count yet -- storage differs by camera model.",
  ...
  "shutter_coverageNote": "Fujifilm, Sony, and Leica cameras show a shutter count right away when the value is stored. Canon and Panasonic photos are read, but their shutter counts use a per-model storage format this tool can't decode yet. Smartphones (iPhone, most Android phones, etc.) have no shutter-count concept at all, so there's nothing to detect.",
