/* =========================================================
   ...
   항목 필드
     ...
     popular   1~N 순위. 있으면 홈 '자주 쓰는 도구'에 노출
     keywords  검색 보조 키워드
   ========================================================= */
...
window.SITE_TOOLS = (function () {
  ...
  var CHIPS = ['연봉 실수령액', 'D-Day', '만 나이', '글자수', '로또'];

  return { CATEGORIES: CATEGORIES, TOOLS: TOOLS, GUIDES: GUIDES, CHIPS: CHIPS };
})();
