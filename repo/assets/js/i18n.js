...
// 홈 리디자인(1a Index)에서 추가된 문구
// ko 만 여기에 둡니다. en / zh / ja 는 assets/i18n/{en,zh,ja}.js 에 추가합니다.
const homeIndexTranslations = {
  ko: {
    ...
    home_searchLabel: '도구 검색', home_searchButton: '검색', home_chipsLabel: '자주 찾는 검색어',
    home_popular_title: '자주 쓰는 도구',
    home_popular_note: '가장 많이 열린 순', home_index_title: '전체 도구', home_search_results: '검색 결과',
