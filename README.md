...
**단계:**
1. [Google AdSense](https://www.google.com/adsense/start/) 방문
2. Google 계정으로 로그인
3. 웹사이트 URL 입력 (예: https://is-an.github.io)
4. 기본 정보 입력 및 약관 동의
5. 사이트에 검증 코드 추가 (자동으로 제공됨)
6. 2-3주 기다려서 승인 대기

**현재 프로젝트 설정:**
- ✅ `ads.txt` 파일 - Google 자동 인증
- ✅ AdSense 스크립트 - index.html에 포함
- ✅ 광고 배치 - footer 영역에 배치

### 2. AdSense 코드 커스터마이징

`index.html`의 AdSense 스크립트:
```html
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8605989057986820"
   crossorigin="anonymous"></script>
```

**본인의 Publisher ID로 변경:**
```html
<!-- ca-pub-8605989057986820을 본인의 ID로 변경 -->
...
**AdSense 대시보드 확인:**
1. [AdSense 대시보드](https://adsense.google.com) 로그인
2. 실시간 수익 모니터링
3. 광고 성과 분석
4. 최적화 제안 확인
